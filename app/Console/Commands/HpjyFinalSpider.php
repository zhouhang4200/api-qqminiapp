...
class HpjyFinalSpider extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'hpjy_final:spider';
     ...
     * @var string
     */
    protected $description = '和平精英最终爬虫';
...
//                'debug'        => true,
            ...
            Video::where('status', 0)
                ...
                ->where('category_id', config('spider.category.hpjy')) // 改第一处
                    ...
                    foreach ($chunks as $video) {
                        try {
                            ...
                            if ($urlDoc) {
                                ...
                                myLog('hpjy_final_spider_error', ['src不存在！']); // 改第二处
//                                $video->delete();
                                continue;
                            }
